        ...
        child: LayoutBuilder(builder: (_, constraints) {
          return Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(top: constraints.maxHeight * 0.036),
                child: Divider(
                  thickness: 1,
              ...
              Padding(
                padding: EdgeInsets.only(top: constraints.maxHeight * 0.016),
                child: Divider(
                  color: Color.fromARGB(255, 255, 164, 81),
                  thickness: 3,
                  indent: constraints.maxWidth * 0.064,
              ...
              Padding(
                  padding: EdgeInsets.only(
                      top: constraints.maxHeight * 0.036, left: 32, right: 32),
              ...
              Padding(
                  padding: EdgeInsets.only(
                      top: constraints.maxWidth * 0.04, left: 24, right: 24),
                  child: Text(
                    widget.description,
                    style: TextStyle(
